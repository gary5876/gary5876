...
카카오테크캠퍼스에서 Java/Spring으로 팀 프로젝트를 했고 Python/FastAPI로는 혼자 설계부터 배포까지 해봤습니다. 요즘은 코딩에이전트로 개발 프로세스를 자동화하는 걸 개인 프로젝트에 적용해보고 있고, 결과를 그냥 받지 않고 검증 기준을 통과한 것만 반영하는 방식으로 씁니다. 앞으로는 이걸 팀 단위 개발 프로세스에도 적용해보고 싶습니다.
